      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-muted-foreground font-cyber mb-6 max-w-xs">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h4 className="font-gaming text-sm uppercase tracking-wider text-foreground mb-4">
                {title}
              </h4>
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-sm text-muted-foreground hover:text-primary font-cyber transition-colors"
                    >
                      {link}
                    </a>
                  </li>
